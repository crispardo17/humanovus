import "./perfilCargo_Educacion.css"
...
const PerfilCargo_Educacion = () => {
  ...
  return  <TableContainer component={Paper} className="perfilCargo_Educacion" >
...
export default PerfilCargo_Educacion