...
import "./tabla_OtrosRequisitos.css"

const Tabla_OtrosRequisitos = () => {
  ...
  return (
    <div>
      <div className='divOtrosRequisitos'>
        <textarea id='otrosRequisitos' className='otrosRequisitos' placeholder='Otros Requisitos...' value={text} onChange={handleTextChange} />
      ...
      <TableContainer>
        <Table sx={{ minWidth: 500 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              <TableCell align="center">REQUISITO</TableCell>
...
export default Tabla_OtrosRequisitos
