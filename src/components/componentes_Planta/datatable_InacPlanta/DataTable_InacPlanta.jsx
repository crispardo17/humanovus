import "./dataTable_InacPlanta.css"
...
const rows = [
  { id: 1, id: 1, cedula: '1018463250', nombre: 'Christhian Alejandro Pardo Cruz', cargo: 'Desarollador', campaña: 'Desarollador',  ciudad: 'Bogota',  fechaIngreso:'18/12/2022' },
...
export default function DataTable_InacPlanta() {
  return (
